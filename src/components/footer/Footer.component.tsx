          ...
          <div className="flex justify-between">
            ...
            <div className="flex gap-[130px]">
              <div className="flex flex-col gap-8">
                <a href="#community" className="text-black font-medium hover:text-[#6001D1]">
                  Community
                </a>
                <a href="#benefits" className="text-black font-medium hover:text-[#6001D1]">
                  Nortech APP benefits
                </a>
                <a href="#habits" className="text-black font-medium hover:text-[#6001D1]">
                  Study habits
                </a>

              </div>
              <div className="flex flex-col gap-8">
                <a href="#nth-learning" className="text-black font-medium hover:text-[#6001D1]">
                  Earn NTH for Learning
                </a>
                <a href="#session-2" className="text-black font-medium hover:text-[#6001D1]">
                  About Nortech
                </a>
                <a href="#questions" className="text-black font-medium hover:text-[#6001D1]">
